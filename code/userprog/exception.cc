    ...
    switch (which) {
        case SyscallException:
            switch (type) {
                ...
                case SC_Read:
                    DEBUG(dbgSys,
                          "read from buffer" << kernel->machine->ReadRegister(4) << kernel->machine->ReadRegister(5)
                                             << kernel->machine->ReadRegister(6) << "\n");
                    int rsize;
                ...
                case SC_Strncmp:
                    DEBUG(dbgSys,
                          "compare two string " << kernel->machine->ReadRegister(4) << kernel->machine->ReadRegister(5)
                                                << kernel->machine->ReadRegister(6) << "\n");
                    int addressFour;
                    ...
                    e = 0;
                    do {
                        kernel->machine->ReadMem(addressFour++, 1,
                                                 (int *) &str1buffer[d++]);//read form addressFour to str1buffer
                    } while (d < 60);
                    --addressFour;
                    do {
